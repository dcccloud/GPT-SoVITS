...
if is_g2pw:
    ...
    g2pw_model_dir = os.path.join(parent_directory,'text','G2PWModel')
    robert_model = os.environ.get('pretrained_bert_name')
    g2pw = G2PWPinyin(model_dir=g2pw_model_dir,model_source=robert_model,v_to_u=False, neutral_tone_with_five=True)
